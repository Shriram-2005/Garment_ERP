  ...
  return (
    <div>
      <div style={{ display: 'flex', alignItems: 'center', gap: '12px', marginBottom: '24px' }}>
        <span className="material-symbols-outlined" style={{ fontSize: '32px', color: 'var(--accent)' }}>local_shipping</span>
        <h1 style={{ fontSize: '24px', fontWeight: '600' }}>Dispatch & Shipment</h1>
      </div>
